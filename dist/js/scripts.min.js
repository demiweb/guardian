...
let teamSlider = [...document.querySelectorAll('.our-team-slider')];
...
let projectSlider = [...document.querySelectorAll('.projects-cont')];
...
let commentsSlider = [...document.querySelectorAll('.clients-list')];

function startCommentsSlider() {
    if (!commentsSlider.length) {

    } else {

        commentsSlider.forEach((sld) => {
            let sldCont = sld.querySelector('.swiper');
...
let headerLang = [...document.querySelectorAll('.header-lang > span')];

function langControl() {
    if (headerLang.length) {
        headerLang.forEach((btn) => {
            btn.addEventListener('click', () => {
                btn.closest('.header-lang').classList.toggle('open');
            })
        })
    }
}
...
let whyList = [...document.querySelectorAll('.why-us__single')];
